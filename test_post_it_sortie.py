...
SAVE_DIR = "./cam_sortie"    # dossier spécifique pour les images de sortie
...
def detect_postit_zones(img, nb_zones=3):
    ...
    for cnt in contours:
        ...
        area = w * h
        if area > 200:  # ignore les petits artefacts
...
print("🎯 Détection automatique des gommettes bleues foncées en cours...")
first_image = None
